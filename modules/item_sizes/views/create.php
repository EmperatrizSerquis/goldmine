...
<div class="w3-card-4">
    ...
    <form class="w3-container" action="<?= $form_location ?>" method="post">
        ...
        <p>
            <label class="w3-text-dark-grey"><b>Type Size </b></label>
            <input type="text" name="type_size" value="<?= $type_size ?>" class="w3-input w3-border w3-sand" placeholder="Enter Type Size ">
        </p>
        <p> 
            <?php 
